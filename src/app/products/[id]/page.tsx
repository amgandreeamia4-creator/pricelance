          ...
          <>
            ...
            <div className="space-y-3 mb-8">
              {shapedListings.map((listing) => (
                <div
                  key={listing.id}
                  className="relative flex items-center justify-between rounded-3xl bg-white/90 p-4 shadow-sm hover:shadow-lg transition-shadow duration-150 overflow-hidden"
                >
                  {/* BEST PRICE badge */}
                  {listing.isBestPrice && (
