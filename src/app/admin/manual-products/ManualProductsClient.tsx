    ...
    try {
      const res = await fetch("/api/admin/listings", {
        ...
        body: JSON.stringify({
          ...
          deliveryTimeDays:
            listingDeliveryDays === "" ? undefined : listingDeliveryDays,
        }),
      });
        ...
        <div className="mb-8 p-4 border border-slate-300 dark:border-slate-700 rounded-2xl bg-white dark:bg-slate-800">
          ...
          <form onSubmit={handleCreateProduct} className="space-y-3">
            ...
            {productMsg && (
              <p
                className={`text-sm ${
                  productMsg.startsWith("Error") ? "text-red-500" : "text-green-600"
                }`}
              >
                {productMsg}
              </p>
                ...
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <div className="text-xs text-slate-500 mt-1">
                      ...
                      {product.category && (
                        <span className="mr-2">Category: {product.category}</span>
                      )}
                      ...
                      <div className="flex items-center pt-4">
                        <label className="flex items-center gap-1.5 text-xs">
                          <input
                            ...
                            onChange={(e) =>
                              setListingFastDelivery(e.target.checked)
                            }
                          />
                          fastDelivery
                        </label>
